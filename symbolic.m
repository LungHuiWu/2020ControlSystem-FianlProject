...
Mf = simplify(Mf);
Mff=subs(Mf,{xb,zb,l1,l2,theta,xb_dot,zb_dot,l1_dot,l2_dot,theta_dot},{xbf,zbf,l1f,l2f,thetaf,xb_dotf,zb_dotf,l1_dotf,l2_dotf,theta_dotf});
...
LambdaN1 = simplify(LambdaN1);
LambdaN2 = simplify(LambdaN2);
LambdaNb = simplify(LambdaNb);
...
LambdaT1 = simplify(LambdaT1);
LambdaT2 = simplify(LambdaT2);
LambdaTb = simplify(LambdaTb);
...
dt=.0005; %time step
x0=[11 0 0 0 1.05 0 0.8 0 0.8 0];  %initial condition
